...
def main():
    write_py(os.path.join(BASE, "bot", "main.py"), r"""
import asyncio
import os
import pkgutil
import importlib
...
""")
    ...
    write_py(os.path.join(BASE, "bot", "routers", "start.py"), r"""
...
""")
    ...
    write_py(os.path.join(BASE, "bot", "routers", "menu.py"), r"""
from aiogram import Router, F
from aiogram.filters import Command
from aiogram.types import Message, InlineKeyboardMarkup, InlineKeyboardButton
router = Router()
...
""")
    ...
    print("\n🎉 3 קבצים נכתבו מחדש  100% BOM‑free")
